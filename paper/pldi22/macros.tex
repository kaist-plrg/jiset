...
% transformations
\newcommand{\trans}{T}
\newcommand{\transf}{\trans_\func}
\newcommand{\transi}{\trans_\inst}
\newcommand{\transe}{\trans_\expr}
\newcommand{\transcpf}{\trans^\name{cp}_\func}
\newcommand{\transcpe}{\trans^\name{cp}_\expr}
\newcommand{\transcpi}{\trans^\name{cp}_\inst}
\newcommand{\transref}{\trans^\name{re}_\func}
\newcommand{\transrei}{\trans^\name{re}_\inst}
\newcommand{\transree}{\trans^\name{re}_\expr}
