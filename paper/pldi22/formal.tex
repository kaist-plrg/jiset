...
\begin{lemma}[Soundness of $\entryaelem$]\label{thm:sound-entryaelem}
...
\begin{lemma}[Soundness of $\atransfer$]\label{thm:sound-atransfer}
...
\begin{lemma}[Soundness of $\asem{\inst}$]\label{thm:sound-inst}
...
\begin{lemma}[Soundness of $\asem{\expr}$]\label{thm:sound-inst}
