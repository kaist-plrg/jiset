...
Our manual investigation found two non-numeric operand bugs (\stextsf{NoNumber})
in one pull request and six unchecked abrupt completion bugs (\stextsf{Abrupt})
...
An unchecked abrupt completion bug occurs when an actual value is necessary but
...
normal completion gets implicitly converted into its actual value \code{42}.
