...
checker}, \textit{assertion checker}, and \textit{operand checker}.  Now, we
explain how each checker detects corresponding bugs in the augmented abstract
transfer $\detector$.
