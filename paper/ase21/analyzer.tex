...
$\tnumeric$ that is either \jscode{Number} or \jscode{BigInt},
...
interested readers to a companion report~\inred{\cite{report}}.
...
and expressions $\aseme{\expr}$ in a companion report~\inred{\cite{report}}.
