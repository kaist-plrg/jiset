...
In the official ECMAScript repository, \inred{1,355} pull
requests and \inred{2,005} commits exist in the master branch.
...
they are also helpful for specification-based tools such as JavaScript
...
javert2}\footnote{https://github.com/tc39/ecmarkup/issues/173}.
...
For mechanized JavaScript specifications by $\jiset$, $\tool$ performs
...
We evaluated $\tool$ with all \inred{864} versions in the official
...
\begin{itemize}
  ...
  \item We demonstrate the practicality of $\tool$. It takes \inred{136.1}
    ...
    \inred{92} out of \inred{177} bugs are true bugs.  Among them, $\tool$ 
    newly detected \inred{14} bugs, and the ECMAScript committee confirmed them all.
\end{itemize}
