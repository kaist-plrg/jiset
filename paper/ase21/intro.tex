...
\begin{itemize}
  ...
  \item We present a \textit{condition-based refinement} for type analysis of
    ...
    precision from \inred{31.8}\% to \inred{56.5}\% by removing \inred{122}
    false bugs and detecting \inred{one} more true bug.
  \item We demonstrate the practicality of $\tool$. It takes \inred{137.3}
    ...
    \inred{91} out of \inred{161} bugs are true bugs.  Among them, $\tool$
