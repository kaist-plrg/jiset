...
9645.5.  In the official repository of ECMAScript, \inred{1,200} pull requests
and \inred{3,000} commits exist in the master branch.  Therefore, it makes more
...
with all \inred{864} different versions existed in the official ECMAScript
...
\begin{itemize}
  ...
  \item We demonstrate the practicality of $\tool$. Our tool took \inred{230}
    ...
    \inred{91} out of \inred{200} bugs are true bugs.  Among them, \inred{14}
