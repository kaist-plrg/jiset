...
\begin{table*}
  ...
  \resizebox{\textwidth}{!}{%
    \begin{tabular}{c|l?r@{~}c@{~}r@{~}l@{}r|r@{~}c@{~}r@{~}l@{}r?r@{~}c@{~}r@{~}l@{}r|r@{~}c@{~}r@{~}l@{}r?r@{~}c@{~}r@{~}l@{}r|r@{~}c@{~}r@{~}l@{}r}
      ...
      {\me{2}{62}{106}{58.5}} {\me{2}{63}{78}{80.8}} {\me{2}{+1}{-28}{+22.3}}
      {\mr{1}{\stextsf{\scriptsize UnknownVar}}}
      {\me{1}{17}{60}{28.3}} {\me{1}{17}{31}{54.8}} {\me{1}{}{-29}{+26.5}}

      \myrowh
      {\mr{1}{\stextsf{\scriptsize DuplicatedVar}}}
      {\me{1}{45}{46}{97.8}} {\me{1}{46}{47}{97.9}} {\me{1}{+1}{+1}{+0.1}}
      ...
      {\mr{1}{\stextsf{\scriptsize Assertion}}}
      {\me{1}{4}{56}{7.1}} {\me{1}{4}{31}{12.9}} {\me{1}{}{-25}{+5.8}}
      ...
      \mysrowh
      {\textbf{Total}}
      {92 / 279 (33.0\%)}{93 / 157 (59.2\%)}{+1 / -122 (+26.3\%)}
...
for specification extraction (\stextsf{extract}),
128.5 seconds for type analysis (\stextsf{analyze}), and
0.8 seconds for bug detection (\stextsf{detect}).
...
17 unknown variables (\stextsf{UnknownVar}) and
46 duplicated variable declarations (\stextsf{DuplicatedVar}) are true bugs.
We found four missing parameters (\stextsf{MissingParam}) with 100.0\% precision and
four assertion failures (\stextsf{Assertion}) with 12.9\% precision.
Finally, the operand checker detected
two non-numeric operand bugs (\stextsf{NoNumber}) with 33.3\% precision and
20 unchecked abrupt completion bugs (\stextsf{Abrupt}) with 52.6\% precision.

To understand the impact of the detected true bugs, we extended $\tool$ to
...
Among 93 true bugs, 49 bugs are \textit{inherited},
which means that they are created before 2018.
Moreover, 14 bugs still exist in the latest ECMAScript, which are newly detected by $\tool$.
We discuss the details of 14 newly found bugs in Section~\ref{sec:new-bug}.
Even though we assume that 49 inherited bugs are created on January 1, 2018,
the average life span is 422.8 and the maximum life span is 1,164.
...
\begin{table*}
  ...
  \begin{tabular}{@{}c@{~}?c|@{~}c@{~}|l|c|@{~}c@{~}|@{~}r@{}}
    ...
    \multicolumn{1}{@{}c@{~}}{\textbf{Life Span}}\\\specialrule{.1em}{.0em}{.0em}
...
operand bugs (\stextsf{NoNumber}) from 3.1\% to 33.3\%
...
(\stextsf{Assertion}) by removing 29 and 25 false-positive bugs, respectively.
