...
resolved by whom as described in Figure~\ref{fig:author}.  Among \inred{92}
true bugs, \inred{47} bugs are \textit{inherited}, which means that they are
created before 2018, and \inred{14} bugs are newly found 
