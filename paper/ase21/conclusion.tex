...
Our tool took \inred{136.0} seconds on average to perform type analysis for each
version, and detected \inred{177} type-related specification bugs with
\inred{52.0}\% precision; \inred{92} out of \inred{177} bugs are true bugs.
