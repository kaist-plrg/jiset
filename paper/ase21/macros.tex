...
\newcommand{\fcode}[1]{\text{\lstinline[style=code, basicstyle=\footnotesize\ttfamily]!#1!}}
...
\newcommand{\val}{v}
\newcommand{\tnameset}{\tyset_\tname}
\newcommand{\constset}{\valset_\const}
\newcommand{\strset}{\valset_\str}
...
\newcommand{\kwfunc}[3]{{\kwdef \; #1 \kwrl #2 \kwrr #3}}
...
\newcommand{\myrowh}[4]{
  \cline{2-2}\cline{8-12}\cline{18-22}\cline{28-32}
  & #1 &
  &&&&& #2 &
  &&&&& #3 &
  &&&&& #4 \\
...
\newcommand{\smyrowc}[5]{
  \myrowc{#1}{#3}{#4}{#5}{#2}{#3}{#4}{#5}
}
\newcommand{\mysrowh}[4]{
\multicolumn{2}{c?}{#1}&
\multicolumn{10}{c?}{\inred{#2}}&
\multicolumn{10}{c?}{\inred{#3}}&
\multicolumn{10}{c}{\inred{#4}}\\
}
