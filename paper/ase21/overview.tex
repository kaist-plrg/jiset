...
To andle views separately, we use a worklist algorithm.
...
specific view from the worklist and udpates the abstract environments of the next
...
algorithm executes with additional parameters \textit{iteratorRecord} and
...
parameter \jscode{x} has the value \jscode{true}, and \jscode{Math.round} is invoked
