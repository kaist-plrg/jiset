...
assertion did not consider \jscode{undefined} introduced by the initial commit
...
It makes the specification tries to compare a boolean value \jscode{true} with a
