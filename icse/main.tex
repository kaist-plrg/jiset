...
\title{JSSET: JavaScript Syntax and Semantics Extraction Toolchain}
...
To alleviate such problems, we propose JSSET, a JavaScript Syntax and Semantics
...
Moreover, JSSET also successfully extracts semantics for \inred{XX} proposed features
by adding only \inred{XX} minor conversion rules.
\end{abstract}
