...
Our approach provides a framework to generate syntactic parsers and
semantics compilers from the specification to \( \ires \)
with a conversion assistant, which reduces human efforts significantly.
