...
contains \inred{XX} compile rules and generates \( \ires \) instructions.
...
like \( \code{9.4.1.1} \), and it converts such numbers to
corresponding name strings like \( \code{"BoundFunctionExoticObject.Call"} \):
