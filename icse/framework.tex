\section{Building entire system to extract semantics}\label{sec:framework}
% In this section, we explain how to automatically generate
% {\sf AST-\( \ires \) Translator} from a given ECMAScript specification
