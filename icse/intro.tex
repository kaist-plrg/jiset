...
\( \tool \) to such proposals; out of \inred{XX} proposals, the tool
passed all the tests in \inred{XX} proposals and partially passed the
tests in \inred{XX} proposals.
...
indeed found \inred{X} possible specification errors in ECMAScript
2020; we reported them to TC39 and \inred{X} errors were confirmed and
the remaining \inred{X} errors are under review.
\end{itemize}
