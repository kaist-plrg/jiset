...
It suggests new conversion rules based on
...
It makes easy not only construct conversion rules from the scratch
but also updates existing conversion rules to handle specification updates.
We explain each helper function and how to utilize it to construct conversion rules.
