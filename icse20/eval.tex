...
Finally, we tested 19,282 applicable tests with our JavaScript
interpreter and only 62 tests are failed. Among them, 54 tests
utilize implementation-dependent features and 3 tests are timeout
and 5 tests are wrong tests. Thus, we believe that all the
