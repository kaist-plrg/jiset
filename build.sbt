...
// TODO lazy val test262ESParseTest = taskKey[Unit]("Launch esparse test262 tests (large)")
...
lazy val jiset = (project in file("."))
  .settings(
    ...
    // TODO test262ESParseTest := (testOnly in Test).toTask(" *.test262.ESParse*Test").value,
