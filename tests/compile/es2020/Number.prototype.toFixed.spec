          ...
          1. Else,
            1. Let _n_ be an integer for which ℝ(_n_) ÷ 10<sub>ℝ</sub><sup>ℝ(_f_)</sup> - ℝ(_x_) is as close to zero as possible. If there are two such _n_, pick the larger _n_.
