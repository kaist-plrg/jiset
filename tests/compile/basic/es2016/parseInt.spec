        ...
        1. Let _sign_ be 1.
        1. If _S_ is not empty and the first code unit of _S_ is 0x002D (HYPHEN-MINUS), let _sign_ be -1.
        1. If _S_ is not empty and the first code unit of _S_ is 0x002B (PLUS SIGN) or 0x002D (HYPHEN-MINUS), remove the first code unit from _S_.
