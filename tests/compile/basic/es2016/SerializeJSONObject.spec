          ...
          1. Let _indent_ be the concatenation of _indent_ and _gap_.
          ...
          1. For each element _P_ of _K_,
            ...
            1. If _strP_ is not *undefined*, then
              ...
              1. Let _member_ be the concatenation of _member_ and the string `":"`.
              1. If _gap_ is not the empty String, then
                1. Let _member_ be the concatenation of _member_ and code unit 0x0020 (SPACE).
              1. Let _member_ be the concatenation of _member_ and _strP_.
