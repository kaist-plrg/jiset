          ...
          1. For each code unit _C_ in _value_, do
            1. If _C_ is 0x0022 (QUOTATION MARK) or 0x005C (REVERSE SOLIDUS), then
              1. Set _product_ to the concatenation of _product_ and code unit 0x005C (REVERSE SOLIDUS).
              1. Set _product_ to the concatenation of _product_ and _C_.
            1. Else if _C_ is 0x0008 (BACKSPACE), 0x000C (FORM FEED), 0x000A (LINE FEED), 0x000D (CARRIAGE RETURN), or 0x0009 (CHARACTER TABULATION), then
              ...
              1. Set _product_ to the concatenation of _product_ and _abbrev_.
            1. Else if _C_ has a code unit value less than 0x0020 (SPACE), then
              1. Set _product_ to the concatenation of _product_ and code unit 0x005C (REVERSE SOLIDUS).
              1. Set _product_ to the concatenation of _product_ and `"u"`.
              ...
              1. Set _product_ to the concatenation of _product_ and _hex_.
            1. Else,
              1. Set _product_ to the concatenation of _product_ and _C_.
          1. Set _product_ to the concatenation of _product_ and code unit 0x0022 (QUOTATION MARK).
          1. Return _product_.