...
% TODO as an open source tool\footnote{The URL of the tool
% is anonymized due to a double-blind review process.}
...
most recent five versions of ECMAScript, ES6 to ES10.
We measured for how many grammar productions and
...
\begin{table}[t]
  \centering
  \caption{Testing results of Test262 for ES10}
  \label{table:test262}
\vspace*{-.5em}
\footnotesize
  \begin{tabular}{lr}\toprule
    ...
    \belowrulesepcolor{gainsboro}
    \rowcolor{gainsboro} \textbf{ES10 Tests} & \textbf{29,125}\\
    \aboverulesepcolor{gainsboro}\midrule
...
interpreter based on the extracted syntax and semantics from ES10.
Among 9,657 steps in ES10,
...
via the \textsf{Fault Localizer} introduced in Section~\ref{sec:localizer}.
...
them to focus on the semantics of ES10.  As Table~\ref{table:test262} shows,
...
integrates it into the next version of ECMAScript.
...
We extended ES10 with this proposal and applied \( \tool \)
...
from existing ECMAScript.  Thus, we revised them to the
...
ES10, we found three specification errors.  We fixed them
