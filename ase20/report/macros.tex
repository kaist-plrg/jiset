...
\newcommand{\hgettype}[3]{#3 = \code{GetType}(#1, #2)}
...
\newcommand{\hpop}[5]{(#4, #5) = \code{Pop}(#1, #2, #3)}
\newcommand{\hiscompletion}[3]{#3 = \code{IsCompletion}(#1, #2)}
\newcommand{\hisinstanceof}[3]{#3 = \code{IsInstanceOf}(#1, #2)}
\newcommand{\hgetelems}[5]{(#4, #5) = \code{GetElems}(#1, #2, #3)}
\newcommand{\hgetsytax}[2]{#2 = \code{GetSyntax}(#1)}
\newcommand{\hparse}[4]{#4 = \code{Parse}(#1, #2, #3)}
\newcommand{\hconvert}[4]{#4 = \code{Convert}(#1, #2, #3)}
\newcommand{\hcontains}[4]{#4 = \code{Contains}(#1, #2, #3)}
\newcommand{\hkeys}[4]{(#3, #4) = \code{Keys}(#1, #2)}
\newcommand{\hlookup}[3]{#3 = \code{Lookup}(#1, #2)}
