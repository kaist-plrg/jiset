...
ALL(*)~\inred{\cite{all-star}}.  However, they are not directly applicable for the
...
Packrat parsing~\cite{packrat}.  \inred{Moreover, we also
implemented the \textit{growing the seed} technique presented
by~\citet{packrat-lr} to support direct and even indirect left recursive
productions.  It enables the synthesis of parsers without changing the structure of
