...
\begin{itemize}[leftmargin=0.5cm]
  ...
  \item \textbf{\( \tool \) bridges the gap between tests and the specification
    ...
    the ECMAScript.  It gives opportunity to directly verify the specification
    through the official test conformance suite, Test262~\cite{test262}.  We
    manually completed the missing parts for the latest ECMAScript (ES10, 2019),
    and it is the \textit{first IR-based formal semantics of modern JavaScript}.
    By executing tests, we found \inred{X} specification errors in ES10 and
    \inred{XX} wrong tests in Test262. They were all confirmed by TC39 and will
    be fixed in the next release.  After fixing them, our formal semantics
