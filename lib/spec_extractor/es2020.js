  ...
  with(SpecExtractor) {
    ...
    function addMethod(name, length, data) {
      ...
      if (name == 'GLOBAL.Array.prototype.sort'
        ...
        return;
      } else if (name == 'GLOBAL.Array.prototype.push' || name == 'GLOBAL.Array.prototype.concat' || name == 'GLOBAL.Array.prototype.unshift' || name == 'GLOBAL.Number.prototype.toString' || name == 'GLOBAL.String.fromCodePoint') {
        length = 1;
        ...
        addMethod('CallExpression5Evaluation0', length, data);
      ...
      data.length = length;
      data.filename = `es2020/algorithm/${name}.json`;
    ...
    save(zip, spec, 'es2020/spec.json');
