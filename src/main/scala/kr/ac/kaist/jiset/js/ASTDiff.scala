...
object ASTDiff {
  ...
  def diff(l: IdentifierReference, r: IdentifierReference): Unit = (l, r) match {
    case (AbsIdentifierReference, _) | (_, AbsIdentifierReference) =>
  ...
  def diff(l: BindingIdentifier, r: BindingIdentifier): Unit = (l, r) match {
    case (AbsBindingIdentifier, _) | (_, AbsBindingIdentifier) =>
  ...
  def diff(l: LabelIdentifier, r: LabelIdentifier): Unit = (l, r) match {
    case (AbsLabelIdentifier, _) | (_, AbsLabelIdentifier) =>
  ...
  def diff(l: CoverParenthesizedExpressionAndArrowParameterList, r: CoverParenthesizedExpressionAndArrowParameterList): Unit = (l, r) match {
    case (AbsCoverParenthesizedExpressionAndArrowParameterList, _) | (_, AbsCoverParenthesizedExpressionAndArrowParameterList) =>
  ...
  def diff(l: ArrayLiteral, r: ArrayLiteral): Unit = (l, r) match {
    case (AbsArrayLiteral, _) | (_, AbsArrayLiteral) =>
  ...
  def diff(l: ElementList, r: ElementList): Unit = (l, r) match {
    case (AbsElementList, _) | (_, AbsElementList) =>
  ...
  def diff(l: Elision, r: Elision): Unit = (l, r) match {
    case (AbsElision, _) | (_, AbsElision) =>
  ...
  def diff(l: PropertyDefinitionList, r: PropertyDefinitionList): Unit = (l, r) match {
    case (AbsPropertyDefinitionList, _) | (_, AbsPropertyDefinitionList) =>
  ...
  def diff(l: PropertyDefinition, r: PropertyDefinition): Unit = (l, r) match {
    case (AbsPropertyDefinition, _) | (_, AbsPropertyDefinition) =>
  ...
  def diff(l: PropertyName, r: PropertyName): Unit = (l, r) match {
    case (AbsPropertyName, _) | (_, AbsPropertyName) =>
  ...
  def diff(l: LiteralPropertyName, r: LiteralPropertyName): Unit = (l, r) match {
    case (AbsLiteralPropertyName, _) | (_, AbsLiteralPropertyName) =>
  ...
  def diff(l: ComputedPropertyName, r: ComputedPropertyName): Unit = (l, r) match {
    case (AbsComputedPropertyName, _) | (_, AbsComputedPropertyName) =>
  ...
  def diff(l: CoverInitializedName, r: CoverInitializedName): Unit = (l, r) match {
    case (AbsCoverInitializedName, _) | (_, AbsCoverInitializedName) =>
  ...
  def diff(l: SubstitutionTemplate, r: SubstitutionTemplate): Unit = (l, r) match {
    case (AbsSubstitutionTemplate, _) | (_, AbsSubstitutionTemplate) =>
  ...
  def diff(l: TemplateSpans, r: TemplateSpans): Unit = (l, r) match {
    case (AbsTemplateSpans, _) | (_, AbsTemplateSpans) =>
  ...
  def diff(l: TemplateMiddleList, r: TemplateMiddleList): Unit = (l, r) match {
    case (AbsTemplateMiddleList, _) | (_, AbsTemplateMiddleList) =>
  ...
  def diff(l: MemberExpression, r: MemberExpression): Unit = (l, r) match {
    case (AbsMemberExpression, _) | (_, AbsMemberExpression) =>
  ...
  def diff(l: SuperProperty, r: SuperProperty): Unit = (l, r) match {
    case (AbsSuperProperty, _) | (_, AbsSuperProperty) =>
  ...
  def diff(l: MetaProperty, r: MetaProperty): Unit = (l, r) match {
    case (AbsMetaProperty, _) | (_, AbsMetaProperty) =>
  ...
  def diff(l: CallExpression, r: CallExpression): Unit = (l, r) match {
    case (AbsCallExpression, _) | (_, AbsCallExpression) =>
  ...
  def diff(l: ArgumentList, r: ArgumentList): Unit = (l, r) match {
    case (AbsArgumentList, _) | (_, AbsArgumentList) =>
  ...
  def diff(l: OptionalExpression, r: OptionalExpression): Unit = (l, r) match {
    case (AbsOptionalExpression, _) | (_, AbsOptionalExpression) =>
  ...
  def diff(l: OptionalChain, r: OptionalChain): Unit = (l, r) match {
    case (AbsOptionalChain, _) | (_, AbsOptionalChain) =>
  ...
  def diff(l: LeftHandSideExpression, r: LeftHandSideExpression): Unit = (l, r) match {
    case (AbsLeftHandSideExpression, _) | (_, AbsLeftHandSideExpression) =>
  ...
  def diff(l: CallMemberExpression, r: CallMemberExpression): Unit = (l, r) match {
    case (AbsCallMemberExpression, _) | (_, AbsCallMemberExpression) =>
  ...
  def diff(l: UpdateExpression, r: UpdateExpression): Unit = (l, r) match {
    case (AbsUpdateExpression, _) | (_, AbsUpdateExpression) =>
  ...
  def diff(l: UnaryExpression, r: UnaryExpression): Unit = (l, r) match {
    case (AbsUnaryExpression, _) | (_, AbsUnaryExpression) =>
  ...
  def diff(l: ExponentiationExpression, r: ExponentiationExpression): Unit = (l, r) match {
    case (AbsExponentiationExpression, _) | (_, AbsExponentiationExpression) =>
  ...
  def diff(l: MultiplicativeExpression, r: MultiplicativeExpression): Unit = (l, r) match {
    case (AbsMultiplicativeExpression, _) | (_, AbsMultiplicativeExpression) =>
  ...
  def diff(l: MultiplicativeOperator, r: MultiplicativeOperator): Unit = (l, r) match {
    case (AbsMultiplicativeOperator, _) | (_, AbsMultiplicativeOperator) =>
  ...
  def diff(l: AdditiveExpression, r: AdditiveExpression): Unit = (l, r) match {
    case (AbsAdditiveExpression, _) | (_, AbsAdditiveExpression) =>
  ...
  def diff(l: ShiftExpression, r: ShiftExpression): Unit = (l, r) match {
    case (AbsShiftExpression, _) | (_, AbsShiftExpression) =>
  ...
  def diff(l: RelationalExpression, r: RelationalExpression): Unit = (l, r) match {
    case (AbsRelationalExpression, _) | (_, AbsRelationalExpression) =>
  ...
  def diff(l: EqualityExpression, r: EqualityExpression): Unit = (l, r) match {
    case (AbsEqualityExpression, _) | (_, AbsEqualityExpression) =>
  ...
  def diff(l: BitwiseANDExpression, r: BitwiseANDExpression): Unit = (l, r) match {
    case (AbsBitwiseANDExpression, _) | (_, AbsBitwiseANDExpression) =>
  ...
  def diff(l: BitwiseXORExpression, r: BitwiseXORExpression): Unit = (l, r) match {
    case (AbsBitwiseXORExpression, _) | (_, AbsBitwiseXORExpression) =>
  ...
  def diff(l: BitwiseORExpression, r: BitwiseORExpression): Unit = (l, r) match {
    case (AbsBitwiseORExpression, _) | (_, AbsBitwiseORExpression) =>
  ...
  def diff(l: LogicalANDExpression, r: LogicalANDExpression): Unit = (l, r) match {
    case (AbsLogicalANDExpression, _) | (_, AbsLogicalANDExpression) =>
  ...
  def diff(l: LogicalORExpression, r: LogicalORExpression): Unit = (l, r) match {
    case (AbsLogicalORExpression, _) | (_, AbsLogicalORExpression) =>
  ...
  def diff(l: CoalesceExpression, r: CoalesceExpression): Unit = (l, r) match {
    case (AbsCoalesceExpression, _) | (_, AbsCoalesceExpression) =>
  ...
  def diff(l: CoalesceExpressionHead, r: CoalesceExpressionHead): Unit = (l, r) match {
    case (AbsCoalesceExpressionHead, _) | (_, AbsCoalesceExpressionHead) =>
  ...
  def diff(l: ShortCircuitExpression, r: ShortCircuitExpression): Unit = (l, r) match {
    case (AbsShortCircuitExpression, _) | (_, AbsShortCircuitExpression) =>
  ...
  def diff(l: ConditionalExpression, r: ConditionalExpression): Unit = (l, r) match {
    case (AbsConditionalExpression, _) | (_, AbsConditionalExpression) =>
  ...
  def diff(l: AssignmentExpression, r: AssignmentExpression): Unit = (l, r) match {
    case (AbsAssignmentExpression, _) | (_, AbsAssignmentExpression) =>
  ...
  def diff(l: AssignmentOperator, r: AssignmentOperator): Unit = (l, r) match {
    case (AbsAssignmentOperator, _) | (_, AbsAssignmentOperator) =>
  ...
  def diff(l: AssignmentPattern, r: AssignmentPattern): Unit = (l, r) match {
    case (AbsAssignmentPattern, _) | (_, AbsAssignmentPattern) =>
  ...
  def diff(l: ObjectAssignmentPattern, r: ObjectAssignmentPattern): Unit = (l, r) match {
    case (AbsObjectAssignmentPattern, _) | (_, AbsObjectAssignmentPattern) =>
  ...
  def diff(l: ArrayAssignmentPattern, r: ArrayAssignmentPattern): Unit = (l, r) match {
    case (AbsArrayAssignmentPattern, _) | (_, AbsArrayAssignmentPattern) =>
  ...
  def diff(l: AssignmentRestProperty, r: AssignmentRestProperty): Unit = (l, r) match {
    case (AbsAssignmentRestProperty, _) | (_, AbsAssignmentRestProperty) =>
  ...
  def diff(l: AssignmentPropertyList, r: AssignmentPropertyList): Unit = (l, r) match {
    case (AbsAssignmentPropertyList, _) | (_, AbsAssignmentPropertyList) =>
  ...
  def diff(l: AssignmentElementList, r: AssignmentElementList): Unit = (l, r) match {
    case (AbsAssignmentElementList, _) | (_, AbsAssignmentElementList) =>
  ...
  def diff(l: AssignmentElisionElement, r: AssignmentElisionElement): Unit = (l, r) match {
    case (AbsAssignmentElisionElement, _) | (_, AbsAssignmentElisionElement) =>
  ...
  def diff(l: AssignmentProperty, r: AssignmentProperty): Unit = (l, r) match {
    case (AbsAssignmentProperty, _) | (_, AbsAssignmentProperty) =>
  ...
  def diff(l: AssignmentElement, r: AssignmentElement): Unit = (l, r) match {
    case (AbsAssignmentElement, _) | (_, AbsAssignmentElement) =>
  ...
  def diff(l: AssignmentRestElement, r: AssignmentRestElement): Unit = (l, r) match {
    case (AbsAssignmentRestElement, _) | (_, AbsAssignmentRestElement) =>
  ...
  def diff(l: DestructuringAssignmentTarget, r: DestructuringAssignmentTarget): Unit = (l, r) match {
    case (AbsDestructuringAssignmentTarget, _) | (_, AbsDestructuringAssignmentTarget) =>
  ...
  def diff(l: Expression, r: Expression): Unit = (l, r) match {
    case (AbsExpression, _) | (_, AbsExpression) =>
  ...
  def diff(l: Statement, r: Statement): Unit = (l, r) match {
    case (AbsStatement, _) | (_, AbsStatement) =>
  ...
  def diff(l: Declaration, r: Declaration): Unit = (l, r) match {
    case (AbsDeclaration, _) | (_, AbsDeclaration) =>
  ...
  def diff(l: HoistableDeclaration, r: HoistableDeclaration): Unit = (l, r) match {
    case (AbsHoistableDeclaration, _) | (_, AbsHoistableDeclaration) =>
  ...
  def diff(l: BreakableStatement, r: BreakableStatement): Unit = (l, r) match {
    case (AbsBreakableStatement, _) | (_, AbsBreakableStatement) =>
  ...
  def diff(l: StatementList, r: StatementList): Unit = (l, r) match {
    case (AbsStatementList, _) | (_, AbsStatementList) =>
  ...
  def diff(l: StatementListItem, r: StatementListItem): Unit = (l, r) match {
    case (AbsStatementListItem, _) | (_, AbsStatementListItem) =>
  ...
  def diff(l: BindingList, r: BindingList): Unit = (l, r) match {
    case (AbsBindingList, _) | (_, AbsBindingList) =>
  ...
  def diff(l: LexicalBinding, r: LexicalBinding): Unit = (l, r) match {
    case (AbsLexicalBinding, _) | (_, AbsLexicalBinding) =>
  ...
  def diff(l: VariableStatement, r: VariableStatement): Unit = (l, r) match {
    case (AbsVariableStatement, _) | (_, AbsVariableStatement) =>
  ...
  def diff(l: VariableDeclarationList, r: VariableDeclarationList): Unit = (l, r) match {
    case (AbsVariableDeclarationList, _) | (_, AbsVariableDeclarationList) =>
  ...
  def diff(l: VariableDeclaration, r: VariableDeclaration): Unit = (l, r) match {
    case (AbsVariableDeclaration, _) | (_, AbsVariableDeclaration) =>
  ...
  def diff(l: BindingPattern, r: BindingPattern): Unit = (l, r) match {
    case (AbsBindingPattern, _) | (_, AbsBindingPattern) =>
  ...
  def diff(l: ObjectBindingPattern, r: ObjectBindingPattern): Unit = (l, r) match {
    case (AbsObjectBindingPattern, _) | (_, AbsObjectBindingPattern) =>
  ...
  def diff(l: ArrayBindingPattern, r: ArrayBindingPattern): Unit = (l, r) match {
    case (AbsArrayBindingPattern, _) | (_, AbsArrayBindingPattern) =>
  ...
  def diff(l: BindingRestProperty, r: BindingRestProperty): Unit = (l, r) match {
    case (AbsBindingRestProperty, _) | (_, AbsBindingRestProperty) =>
  ...
  def diff(l: BindingPropertyList, r: BindingPropertyList): Unit = (l, r) match {
    case (AbsBindingPropertyList, _) | (_, AbsBindingPropertyList) =>
  ...
  def diff(l: BindingElementList, r: BindingElementList): Unit = (l, r) match {
    case (AbsBindingElementList, _) | (_, AbsBindingElementList) =>
  ...
  def diff(l: BindingElisionElement, r: BindingElisionElement): Unit = (l, r) match {
    case (AbsBindingElisionElement, _) | (_, AbsBindingElisionElement) =>
  ...
  def diff(l: BindingProperty, r: BindingProperty): Unit = (l, r) match {
    case (AbsBindingProperty, _) | (_, AbsBindingProperty) =>
  ...
  def diff(l: BindingElement, r: BindingElement): Unit = (l, r) match {
    case (AbsBindingElement, _) | (_, AbsBindingElement) =>
  ...
  def diff(l: SingleNameBinding, r: SingleNameBinding): Unit = (l, r) match {
    case (AbsSingleNameBinding, _) | (_, AbsSingleNameBinding) =>
  ...
  def diff(l: BindingRestElement, r: BindingRestElement): Unit = (l, r) match {
    case (AbsBindingRestElement, _) | (_, AbsBindingRestElement) =>
  ...
  def diff(l: IterationStatement, r: IterationStatement): Unit = (l, r) match {
    case (AbsIterationStatement, _) | (_, AbsIterationStatement) =>
  ...
  def diff(l: ForInOfStatement, r: ForInOfStatement): Unit = (l, r) match {
    case (AbsForInOfStatement, _) | (_, AbsForInOfStatement) =>
  ...
  def diff(l: ContinueStatement, r: ContinueStatement): Unit = (l, r) match {
    case (AbsContinueStatement, _) | (_, AbsContinueStatement) =>
  ...
  def diff(l: BreakStatement, r: BreakStatement): Unit = (l, r) match {
    case (AbsBreakStatement, _) | (_, AbsBreakStatement) =>
  ...
  def diff(l: ReturnStatement, r: ReturnStatement): Unit = (l, r) match {
    case (AbsReturnStatement, _) | (_, AbsReturnStatement) =>
  ...
  def diff(l: CaseClauses, r: CaseClauses): Unit = (l, r) match {
    case (AbsCaseClauses, _) | (_, AbsCaseClauses) =>
  ...
  def diff(l: CaseClause, r: CaseClause): Unit = (l, r) match {
    case (AbsCaseClause, _) | (_, AbsCaseClause) =>
  ...
  def diff(l: DefaultClause, r: DefaultClause): Unit = (l, r) match {
    case (AbsDefaultClause, _) | (_, AbsDefaultClause) =>
  ...
  def diff(l: DebuggerStatement, r: DebuggerStatement): Unit = (l, r) match {
    case (AbsDebuggerStatement, _) | (_, AbsDebuggerStatement) =>
  ...
  def diff(l: UniqueFormalParameters, r: UniqueFormalParameters): Unit = (l, r) match {
    case (AbsUniqueFormalParameters, _) | (_, AbsUniqueFormalParameters) =>
  ...
  def diff(l: FormalParameters, r: FormalParameters): Unit = (l, r) match {
    case (AbsFormalParameters, _) | (_, AbsFormalParameters) =>
  ...
  def diff(l: FormalParameterList, r: FormalParameterList): Unit = (l, r) match {
    case (AbsFormalParameterList, _) | (_, AbsFormalParameterList) =>
  ...
  def diff(l: FunctionRestParameter, r: FunctionRestParameter): Unit = (l, r) match {
    case (AbsFunctionRestParameter, _) | (_, AbsFunctionRestParameter) =>
  ...
  def diff(l: FormalParameter, r: FormalParameter): Unit = (l, r) match {
    case (AbsFormalParameter, _) | (_, AbsFormalParameter) =>
  ...
  def diff(l: FunctionDeclaration, r: FunctionDeclaration): Unit = (l, r) match {
    case (AbsFunctionDeclaration, _) | (_, AbsFunctionDeclaration) =>
  ...
  def diff(l: FunctionExpression, r: FunctionExpression): Unit = (l, r) match {
    case (AbsFunctionExpression, _) | (_, AbsFunctionExpression) =>
  ...
  def diff(l: ConciseBody, r: ConciseBody): Unit = (l, r) match {
    case (AbsConciseBody, _) | (_, AbsConciseBody) =>
  ...
  def diff(l: ExpressionBody, r: ExpressionBody): Unit = (l, r) match {
    case (AbsExpressionBody, _) | (_, AbsExpressionBody) =>
  ...
  def diff(l: ArrowFormalParameters, r: ArrowFormalParameters): Unit = (l, r) match {
    case (AbsArrowFormalParameters, _) | (_, AbsArrowFormalParameters) =>
  ...
  def diff(l: MethodDefinition, r: MethodDefinition): Unit = (l, r) match {
    case (AbsMethodDefinition, _) | (_, AbsMethodDefinition) =>
  ...
  def diff(l: PropertySetParameterList, r: PropertySetParameterList): Unit = (l, r) match {
    case (AbsPropertySetParameterList, _) | (_, AbsPropertySetParameterList) =>
  ...
  def diff(l: GeneratorMethod, r: GeneratorMethod): Unit = (l, r) match {
    case (AbsGeneratorMethod, _) | (_, AbsGeneratorMethod) =>
  ...
  def diff(l: GeneratorDeclaration, r: GeneratorDeclaration): Unit = (l, r) match {
    case (AbsGeneratorDeclaration, _) | (_, AbsGeneratorDeclaration) =>
  ...
  def diff(l: GeneratorExpression, r: GeneratorExpression): Unit = (l, r) match {
    case (AbsGeneratorExpression, _) | (_, AbsGeneratorExpression) =>
  ...
  def diff(l: AsyncGeneratorMethod, r: AsyncGeneratorMethod): Unit = (l, r) match {
    case (AbsAsyncGeneratorMethod, _) | (_, AbsAsyncGeneratorMethod) =>
  ...
  def diff(l: AsyncGeneratorDeclaration, r: AsyncGeneratorDeclaration): Unit = (l, r) match {
    case (AbsAsyncGeneratorDeclaration, _) | (_, AbsAsyncGeneratorDeclaration) =>
  ...
  def diff(l: AsyncGeneratorExpression, r: AsyncGeneratorExpression): Unit = (l, r) match {
    case (AbsAsyncGeneratorExpression, _) | (_, AbsAsyncGeneratorExpression) =>
  ...
  def diff(l: AsyncGeneratorBody, r: AsyncGeneratorBody): Unit = (l, r) match {
    case (AbsAsyncGeneratorBody, _) | (_, AbsAsyncGeneratorBody) =>
  ...
  def diff(l: ClassDeclaration, r: ClassDeclaration): Unit = (l, r) match {
    case (AbsClassDeclaration, _) | (_, AbsClassDeclaration) =>
  ...
  def diff(l: ClassExpression, r: ClassExpression): Unit = (l, r) match {
    case (AbsClassExpression, _) | (_, AbsClassExpression) =>
  ...
  def diff(l: ClassTail, r: ClassTail): Unit = (l, r) match {
    case (AbsClassTail, _) | (_, AbsClassTail) =>
  ...
  def diff(l: ClassElement, r: ClassElement): Unit = (l, r) match {
    case (AbsClassElement, _) | (_, AbsClassElement) =>
  ...
  def diff(l: AsyncFunctionDeclaration, r: AsyncFunctionDeclaration): Unit = (l, r) match {
    case (AbsAsyncFunctionDeclaration, _) | (_, AbsAsyncFunctionDeclaration) =>
  ...
  def diff(l: AsyncFunctionExpression, r: AsyncFunctionExpression): Unit = (l, r) match {
    case (AbsAsyncFunctionExpression, _) | (_, AbsAsyncFunctionExpression) =>
  ...
  def diff(l: AsyncMethod, r: AsyncMethod): Unit = (l, r) match {
    case (AbsAsyncMethod, _) | (_, AbsAsyncMethod) =>
  ...
  def diff(l: AsyncConciseBody, r: AsyncConciseBody): Unit = (l, r) match {
    case (AbsAsyncConciseBody, _) | (_, AbsAsyncConciseBody) =>
  ...
  def diff(l: AsyncArrowBindingIdentifier, r: AsyncArrowBindingIdentifier): Unit = (l, r) match {
    case (AbsAsyncArrowBindingIdentifier, _) | (_, AbsAsyncArrowBindingIdentifier) =>
  ...
  def diff(l: CoverCallExpressionAndAsyncArrowHead, r: CoverCallExpressionAndAsyncArrowHead): Unit = (l, r) match {
    case (AbsCoverCallExpressionAndAsyncArrowHead, _) | (_, AbsCoverCallExpressionAndAsyncArrowHead) =>
  ...
  def diff(l: ModuleItem, r: ModuleItem): Unit = (l, r) match {
    case (AbsModuleItem, _) | (_, AbsModuleItem) =>
  ...
  def diff(l: ImportDeclaration, r: ImportDeclaration): Unit = (l, r) match {
    case (AbsImportDeclaration, _) | (_, AbsImportDeclaration) =>
  ...
  def diff(l: ImportClause, r: ImportClause): Unit = (l, r) match {
    case (AbsImportClause, _) | (_, AbsImportClause) =>
  ...
  def diff(l: ImportedDefaultBinding, r: ImportedDefaultBinding): Unit = (l, r) match {
    case (AbsImportedDefaultBinding, _) | (_, AbsImportedDefaultBinding) =>
  ...
  def diff(l: ImportSpecifier, r: ImportSpecifier): Unit = (l, r) match {
    case (AbsImportSpecifier, _) | (_, AbsImportSpecifier) =>
  ...
  def diff(l: ExportFromClause, r: ExportFromClause): Unit = (l, r) match {
    case (AbsExportFromClause, _) | (_, AbsExportFromClause) =>
  ...
  def diff(l: NamedExports, r: NamedExports): Unit = (l, r) match {
    case (AbsNamedExports, _) | (_, AbsNamedExports) =>
  ...
  def diff(l: ExportsList, r: ExportsList): Unit = (l, r) match {
    case (AbsExportsList, _) | (_, AbsExportsList) =>
  ...
  def diff(l: ExportSpecifier, r: ExportSpecifier): Unit = (l, r) match {
    case (AbsExportSpecifier, _) | (_, AbsExportSpecifier) =>
  ...
  def diff(l: AST, r: AST): Unit = (l, r) match {
    case (l: IdentifierReference, r: IdentifierReference) => diff(l, r)
    case (l: BindingIdentifier, r: BindingIdentifier) => diff(l, r)
    case (l: LabelIdentifier, r: LabelIdentifier) => diff(l, r)
    case (l: Identifier, r: Identifier) => diff(l, r)
    case (l: PrimaryExpression, r: PrimaryExpression) => diff(l, r)
    case (l: CoverParenthesizedExpressionAndArrowParameterList, r: CoverParenthesizedExpressionAndArrowParameterList) => diff(l, r)
    case (l: ParenthesizedExpression, r: ParenthesizedExpression) => diff(l, r)
    case (l: Literal, r: Literal) => diff(l, r)
    case (l: ArrayLiteral, r: ArrayLiteral) => diff(l, r)
    case (l: ElementList, r: ElementList) => diff(l, r)
    case (l: Elision, r: Elision) => diff(l, r)
    case (l: SpreadElement, r: SpreadElement) => diff(l, r)
    case (l: ObjectLiteral, r: ObjectLiteral) => diff(l, r)
    case (l: PropertyDefinitionList, r: PropertyDefinitionList) => diff(l, r)
    case (l: PropertyDefinition, r: PropertyDefinition) => diff(l, r)
    case (l: PropertyName, r: PropertyName) => diff(l, r)
    case (l: LiteralPropertyName, r: LiteralPropertyName) => diff(l, r)
    case (l: ComputedPropertyName, r: ComputedPropertyName) => diff(l, r)
    case (l: CoverInitializedName, r: CoverInitializedName) => diff(l, r)
    case (l: Initializer, r: Initializer) => diff(l, r)
    case (l: TemplateLiteral, r: TemplateLiteral) => diff(l, r)
    case (l: SubstitutionTemplate, r: SubstitutionTemplate) => diff(l, r)
    case (l: TemplateSpans, r: TemplateSpans) => diff(l, r)
    case (l: TemplateMiddleList, r: TemplateMiddleList) => diff(l, r)
    case (l: MemberExpression, r: MemberExpression) => diff(l, r)
    case (l: SuperProperty, r: SuperProperty) => diff(l, r)
    case (l: MetaProperty, r: MetaProperty) => diff(l, r)
    case (l: NewTarget, r: NewTarget) => diff(l, r)
    case (l: ImportMeta, r: ImportMeta) => diff(l, r)
    case (l: NewExpression, r: NewExpression) => diff(l, r)
    case (l: CallExpression, r: CallExpression) => diff(l, r)
    case (l: SuperCall, r: SuperCall) => diff(l, r)
    case (l: ImportCall, r: ImportCall) => diff(l, r)
    case (l: Arguments, r: Arguments) => diff(l, r)
    case (l: ArgumentList, r: ArgumentList) => diff(l, r)
    case (l: OptionalExpression, r: OptionalExpression) => diff(l, r)
    case (l: OptionalChain, r: OptionalChain) => diff(l, r)
    case (l: LeftHandSideExpression, r: LeftHandSideExpression) => diff(l, r)
    case (l: CallMemberExpression, r: CallMemberExpression) => diff(l, r)
    case (l: UpdateExpression, r: UpdateExpression) => diff(l, r)
    case (l: UnaryExpression, r: UnaryExpression) => diff(l, r)
    case (l: ExponentiationExpression, r: ExponentiationExpression) => diff(l, r)
    case (l: MultiplicativeExpression, r: MultiplicativeExpression) => diff(l, r)
    case (l: MultiplicativeOperator, r: MultiplicativeOperator) => diff(l, r)
    case (l: AdditiveExpression, r: AdditiveExpression) => diff(l, r)
    case (l: ShiftExpression, r: ShiftExpression) => diff(l, r)
    case (l: RelationalExpression, r: RelationalExpression) => diff(l, r)
    case (l: EqualityExpression, r: EqualityExpression) => diff(l, r)
    case (l: BitwiseANDExpression, r: BitwiseANDExpression) => diff(l, r)
    case (l: BitwiseXORExpression, r: BitwiseXORExpression) => diff(l, r)
    case (l: BitwiseORExpression, r: BitwiseORExpression) => diff(l, r)
    case (l: LogicalANDExpression, r: LogicalANDExpression) => diff(l, r)
    case (l: LogicalORExpression, r: LogicalORExpression) => diff(l, r)
    case (l: CoalesceExpression, r: CoalesceExpression) => diff(l, r)
    case (l: CoalesceExpressionHead, r: CoalesceExpressionHead) => diff(l, r)
    case (l: ShortCircuitExpression, r: ShortCircuitExpression) => diff(l, r)
    case (l: ConditionalExpression, r: ConditionalExpression) => diff(l, r)
    case (l: AssignmentExpression, r: AssignmentExpression) => diff(l, r)
    case (l: AssignmentOperator, r: AssignmentOperator) => diff(l, r)
    case (l: AssignmentPattern, r: AssignmentPattern) => diff(l, r)
    case (l: ObjectAssignmentPattern, r: ObjectAssignmentPattern) => diff(l, r)
    case (l: ArrayAssignmentPattern, r: ArrayAssignmentPattern) => diff(l, r)
    case (l: AssignmentRestProperty, r: AssignmentRestProperty) => diff(l, r)
    case (l: AssignmentPropertyList, r: AssignmentPropertyList) => diff(l, r)
    case (l: AssignmentElementList, r: AssignmentElementList) => diff(l, r)
    case (l: AssignmentElisionElement, r: AssignmentElisionElement) => diff(l, r)
    case (l: AssignmentProperty, r: AssignmentProperty) => diff(l, r)
    case (l: AssignmentElement, r: AssignmentElement) => diff(l, r)
    case (l: AssignmentRestElement, r: AssignmentRestElement) => diff(l, r)
    case (l: DestructuringAssignmentTarget, r: DestructuringAssignmentTarget) => diff(l, r)
    case (l: Expression, r: Expression) => diff(l, r)
    case (l: Statement, r: Statement) => diff(l, r)
    case (l: Declaration, r: Declaration) => diff(l, r)
    case (l: HoistableDeclaration, r: HoistableDeclaration) => diff(l, r)
    case (l: BreakableStatement, r: BreakableStatement) => diff(l, r)
    case (l: BlockStatement, r: BlockStatement) => diff(l, r)
    case (l: Block, r: Block) => diff(l, r)
    case (l: StatementList, r: StatementList) => diff(l, r)
    case (l: StatementListItem, r: StatementListItem) => diff(l, r)
    case (l: LexicalDeclaration, r: LexicalDeclaration) => diff(l, r)
    case (l: LetOrConst, r: LetOrConst) => diff(l, r)
    case (l: BindingList, r: BindingList) => diff(l, r)
    case (l: LexicalBinding, r: LexicalBinding) => diff(l, r)
    case (l: VariableStatement, r: VariableStatement) => diff(l, r)
    case (l: VariableDeclarationList, r: VariableDeclarationList) => diff(l, r)
    case (l: VariableDeclaration, r: VariableDeclaration) => diff(l, r)
    case (l: BindingPattern, r: BindingPattern) => diff(l, r)
    case (l: ObjectBindingPattern, r: ObjectBindingPattern) => diff(l, r)
    case (l: ArrayBindingPattern, r: ArrayBindingPattern) => diff(l, r)
    case (l: BindingRestProperty, r: BindingRestProperty) => diff(l, r)
    case (l: BindingPropertyList, r: BindingPropertyList) => diff(l, r)
    case (l: BindingElementList, r: BindingElementList) => diff(l, r)
    case (l: BindingElisionElement, r: BindingElisionElement) => diff(l, r)
    case (l: BindingProperty, r: BindingProperty) => diff(l, r)
    case (l: BindingElement, r: BindingElement) => diff(l, r)
    case (l: SingleNameBinding, r: SingleNameBinding) => diff(l, r)
    case (l: BindingRestElement, r: BindingRestElement) => diff(l, r)
    case (l: EmptyStatement, r: EmptyStatement) => diff(l, r)
    case (l: ExpressionStatement, r: ExpressionStatement) => diff(l, r)
    case (l: IfStatement, r: IfStatement) => diff(l, r)
    case (l: IterationStatement, r: IterationStatement) => diff(l, r)
    case (l: DoWhileStatement, r: DoWhileStatement) => diff(l, r)
    case (l: WhileStatement, r: WhileStatement) => diff(l, r)
    case (l: ForStatement, r: ForStatement) => diff(l, r)
    case (l: ForInOfStatement, r: ForInOfStatement) => diff(l, r)
    case (l: ForDeclaration, r: ForDeclaration) => diff(l, r)
    case (l: ForBinding, r: ForBinding) => diff(l, r)
    case (l: ContinueStatement, r: ContinueStatement) => diff(l, r)
    case (l: BreakStatement, r: BreakStatement) => diff(l, r)
    case (l: ReturnStatement, r: ReturnStatement) => diff(l, r)
    case (l: WithStatement, r: WithStatement) => diff(l, r)
    case (l: SwitchStatement, r: SwitchStatement) => diff(l, r)
    case (l: CaseBlock, r: CaseBlock) => diff(l, r)
    case (l: CaseClauses, r: CaseClauses) => diff(l, r)
    case (l: CaseClause, r: CaseClause) => diff(l, r)
    case (l: DefaultClause, r: DefaultClause) => diff(l, r)
    case (l: LabelledStatement, r: LabelledStatement) => diff(l, r)
    case (l: LabelledItem, r: LabelledItem) => diff(l, r)
    case (l: ThrowStatement, r: ThrowStatement) => diff(l, r)
    case (l: TryStatement, r: TryStatement) => diff(l, r)
    case (l: Catch, r: Catch) => diff(l, r)
    case (l: Finally, r: Finally) => diff(l, r)
    case (l: CatchParameter, r: CatchParameter) => diff(l, r)
    case (l: DebuggerStatement, r: DebuggerStatement) => diff(l, r)
    case (l: UniqueFormalParameters, r: UniqueFormalParameters) => diff(l, r)
    case (l: FormalParameters, r: FormalParameters) => diff(l, r)
    case (l: FormalParameterList, r: FormalParameterList) => diff(l, r)
    case (l: FunctionRestParameter, r: FunctionRestParameter) => diff(l, r)
    case (l: FormalParameter, r: FormalParameter) => diff(l, r)
    case (l: FunctionDeclaration, r: FunctionDeclaration) => diff(l, r)
    case (l: FunctionExpression, r: FunctionExpression) => diff(l, r)
    case (l: FunctionBody, r: FunctionBody) => diff(l, r)
    case (l: FunctionStatementList, r: FunctionStatementList) => diff(l, r)
    case (l: ArrowFunction, r: ArrowFunction) => diff(l, r)
    case (l: ArrowParameters, r: ArrowParameters) => diff(l, r)
    case (l: ConciseBody, r: ConciseBody) => diff(l, r)
    case (l: ExpressionBody, r: ExpressionBody) => diff(l, r)
    case (l: ArrowFormalParameters, r: ArrowFormalParameters) => diff(l, r)
    case (l: MethodDefinition, r: MethodDefinition) => diff(l, r)
    case (l: PropertySetParameterList, r: PropertySetParameterList) => diff(l, r)
    case (l: GeneratorMethod, r: GeneratorMethod) => diff(l, r)
    case (l: GeneratorDeclaration, r: GeneratorDeclaration) => diff(l, r)
    case (l: GeneratorExpression, r: GeneratorExpression) => diff(l, r)
    case (l: GeneratorBody, r: GeneratorBody) => diff(l, r)
    case (l: YieldExpression, r: YieldExpression) => diff(l, r)
    case (l: AsyncGeneratorMethod, r: AsyncGeneratorMethod) => diff(l, r)
    case (l: AsyncGeneratorDeclaration, r: AsyncGeneratorDeclaration) => diff(l, r)
    case (l: AsyncGeneratorExpression, r: AsyncGeneratorExpression) => diff(l, r)
    case (l: AsyncGeneratorBody, r: AsyncGeneratorBody) => diff(l, r)
    case (l: ClassDeclaration, r: ClassDeclaration) => diff(l, r)
    case (l: ClassExpression, r: ClassExpression) => diff(l, r)
    case (l: ClassTail, r: ClassTail) => diff(l, r)
    case (l: ClassHeritage, r: ClassHeritage) => diff(l, r)
    case (l: ClassBody, r: ClassBody) => diff(l, r)
    case (l: ClassElementList, r: ClassElementList) => diff(l, r)
    case (l: ClassElement, r: ClassElement) => diff(l, r)
    case (l: AsyncFunctionDeclaration, r: AsyncFunctionDeclaration) => diff(l, r)
    case (l: AsyncFunctionExpression, r: AsyncFunctionExpression) => diff(l, r)
    case (l: AsyncMethod, r: AsyncMethod) => diff(l, r)
    case (l: AsyncFunctionBody, r: AsyncFunctionBody) => diff(l, r)
    case (l: AwaitExpression, r: AwaitExpression) => diff(l, r)
    case (l: AsyncArrowFunction, r: AsyncArrowFunction) => diff(l, r)
    case (l: AsyncConciseBody, r: AsyncConciseBody) => diff(l, r)
    case (l: AsyncArrowBindingIdentifier, r: AsyncArrowBindingIdentifier) => diff(l, r)
    case (l: CoverCallExpressionAndAsyncArrowHead, r: CoverCallExpressionAndAsyncArrowHead) => diff(l, r)
    case (l: AsyncArrowHead, r: AsyncArrowHead) => diff(l, r)
    case (l: Script, r: Script) => diff(l, r)
    case (l: ScriptBody, r: ScriptBody) => diff(l, r)
    case (l: Module, r: Module) => diff(l, r)
    case (l: ModuleBody, r: ModuleBody) => diff(l, r)
    case (l: ModuleItemList, r: ModuleItemList) => diff(l, r)
    case (l: ModuleItem, r: ModuleItem) => diff(l, r)
    case (l: ImportDeclaration, r: ImportDeclaration) => diff(l, r)
    case (l: ImportClause, r: ImportClause) => diff(l, r)
    case (l: ImportedDefaultBinding, r: ImportedDefaultBinding) => diff(l, r)
    case (l: NameSpaceImport, r: NameSpaceImport) => diff(l, r)
    case (l: NamedImports, r: NamedImports) => diff(l, r)
    case (l: FromClause, r: FromClause) => diff(l, r)
    case (l: ImportsList, r: ImportsList) => diff(l, r)
    case (l: ImportSpecifier, r: ImportSpecifier) => diff(l, r)
    case (l: ModuleSpecifier, r: ModuleSpecifier) => diff(l, r)
    case (l: ImportedBinding, r: ImportedBinding) => diff(l, r)
    case (l: ExportDeclaration, r: ExportDeclaration) => diff(l, r)
    case (l: ExportFromClause, r: ExportFromClause) => diff(l, r)
    case (l: NamedExports, r: NamedExports) => diff(l, r)
    case (l: ExportsList, r: ExportsList) => diff(l, r)
    case (l: ExportSpecifier, r: ExportSpecifier) => diff(l, r)
    case _ => diffError(l, r)
  }
}
